...
if (temperature >= 80){
  if (rain){
    ...
    console.log("Wear a longsleeve t-shirt, but no need for an umbrella.");
  }
} else if (temperature > 60 && temperature < 80){
    if (rain){
      console.log("Wear a rain jacket.");
    } else {
      console.log("Its perfect, wear what you want and leave your umbrella at home!");
  }
} else {
    if (rain){
      console.log("Wear a jacket and carry and umbrella.");
    } else {
      console.log("Still take your jacket, but leave the umbrella at home.");
    }
}
//Dev Mountain solution
...
if (changeMyMind){
  changeMyMind = false;
  console.log("True changed to False");
} else {
  changeMyMind = true;
  console.log("False changed to True");
}
////////// PROBLEM 10 //////////
